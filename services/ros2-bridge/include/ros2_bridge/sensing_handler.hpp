#ifndef ROS2_BRIDGE_SENSING_HANDLER_HPP
#define ROS2_BRIDGE_SENSING_HANDLER_HPP
...
public:
    ...
    grpc::Status ListNodes(
        grpc::ServerContext* context,
        const drs::ros2bridge::v1::ListNodesRequest* request,
...
private:
    ...
    void convertNavSatFixToPosition(
        const sensor_msgs::msg::NavSatFix& nav_sat_fix,
        drs::ros2bridge::v1::Position* position);
...
#endif // ROS2_BRIDGE_SENSING_HANDLER_HPP
